...
for f in "${files[@]}"; do
  ...
  ${G2O_ROOT}/bin/g2o -v -i 100 -guessOdometry -solver gn_fix6_3_cholmod -robustKernel Cauchy -robustKernelWidth 1.0 -guessOdometry -stats ${stats_file_geodesic} -o ${output_file_geodesic} ${f}
