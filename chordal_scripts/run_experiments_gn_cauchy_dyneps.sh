...
for d in "${directories[@]}"; do
  ...
  ${pwd}/run_gn_cauchy_no_guess_dyneps.sh ${d}/ ${statics_directory_dataset}
  # read -p "press any key to continue"

  ${pwd}/run_gn_cauchy_spanning_dyneps.sh ${d}/ ${statics_directory_dataset}
  # read -p "press any key to continue"

  ${pwd}/run_gn_cauchy_odom_dyneps.sh ${d}/ ${statics_directory_dataset}
  # read -p "press any key to continue"
