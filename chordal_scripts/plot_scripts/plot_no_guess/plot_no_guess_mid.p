...
# set out 'plot_no_guess_mid.png'

# set terminal epslatex color
# set out 'plot_no_guess_mid.tex'

#set terminal postscript eps enhanced color font 'Helvetica,10'
set terminal postscript eps enhanced color
set output 'plot_no_guess_mid.eps'
...
plot '../output/garage_mid.stats' using 2:8 with linespoints linestyle 1 title 'standard', \
'../compare/garage_mid.stats' using 1:3 with lines linestyle 2 title 'chordal reprojected', \
'../chordal/output/garage_mid.stats' using 2:8 with lines linestyle 4 title 'chordal'
