...
plot '../chordal/output_gn_noguess/sphere-a_high.stats' using 1:2 with linespoints linestyle 4 title 'no guess chordal', \
'../output_gn_noguess/sphere-a_high.stats' using 2:8 with linespoints linestyle 7 title 'no guess geodesic', \
'../chordal/output_gn_spanning/sphere-a_high.stats' using 1:2 with lines linestyle 5 title 'spanning chordal', \
'../chordal/output_gn_odometry/sphere-a_high.stats' using 1:2 with lines linestyle 6 title 'odometry chordal', \
'../output_gn_spanning/sphere-a_high.stats' using 2:8 with lines linestyle 8 title 'spanning geodesic', \
'../output_gn_odometry/sphere-a_high.stats' using 2:8 with lines linestyle 9 title 'odometry geodesic'
