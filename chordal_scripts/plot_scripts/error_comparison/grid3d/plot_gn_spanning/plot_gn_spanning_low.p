...
plot '../output_gn_spanning/grid3d_low.stats' using 2:8 with linespoints linestyle 1 title 'standard', \
'../chordal/output_gn_spanning/grid3d_low.stats' using 1:3 with lines linestyle 2 title 'chordal reprojected', \
'../chordal/output_gn_spanning/grid3d_low.stats' using 1:2 with lines linestyle 4 title 'chordal'
