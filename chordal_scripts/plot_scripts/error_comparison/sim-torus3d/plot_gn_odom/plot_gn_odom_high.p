...
# set out 'plot_gn_odom_high.png'

# set terminal epslatex color
# set out 'plot_gn_odom_high.tex'

#set terminal postscript eps enhanced color font 'Helvetica,10'
set terminal postscript eps enhanced color
set output 'plot_gn_odom_high.eps'
...
plot '../output_gn_odometry/sim-torus3d_high.stats' using 2:8 with linespoints linestyle 1 title 'standard', \
'../chordal/output_gn_odometry/sim-torus3d_high.stats' using 1:3 with lines linestyle 2 title 'chordal reprojected', \
'../chordal/output_gn_odometry/sim-torus3d_high.stats' using 1:2 with lines linestyle 4 title 'chordal'
