...
# set out 'plot_gn_spanning_mid.png'

# set terminal epslatex color
# set out 'plot_gn_spanning_mid.tex'

#set terminal postscript eps enhanced color font 'Helvetica,10'
set terminal postscript eps enhanced color
set output 'plot_gn_spanning_mid.eps'
...
set title 'Comparison Between Chordal and Geodesic - Mid Noise'
plot '../output_gn_spanning/sim-torus3d_mid.stats' using 2:8 with linespoints linestyle 1 title 'standard', \
'../chordal/output_gn_spanning/sim-torus3d_mid.stats' using 1:3 with lines linestyle 2 title 'chordal reprojected', \
'../chordal/output_gn_spanning/sim-torus3d_mid.stats' using 1:2 with lines linestyle 4 title 'chordal'
