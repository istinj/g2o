...
echo -e ${UCYAN}gn odometry${NC}
cd ${target_dir}
echo $'\n'

output_directory=output_gn_odometry
...
output_directory_chordal=chordal/output_gn_odometry
...
for f in "${files[@]}"; do
  ...
  ${G2O_ROOT}/bin/g2o -v -i 100 -guessOdometry -solver gn_fix6_3_cholmod -stats ${stats_file_standard} -o ${output_file_standard} ${f}
  
  # echo $'\n'
  # echo -e ${YELLOW}chordal${NC}
  # ${G2O_ROOT}/bin/g2o -v -i 100 -guessOdometry -solver gn_fix6_3_cholmod -stats ${stats_file_chordal} -o ${output_file_chordal} chordal/${f}
  
  # echo $'\n'
  # echo -e ${YELLOW}compare${NC}
  # ${G2O_ROOT}/bin/chordal_comparator -i 100 -guessOdometry -solver gn_fix6_3_cholmod -compareStats ${stats_file_compare} -otherGraph ${f} chordal/${f}
  
  echo $'\n'
  echo -e ${YELLOW}chordal${NC}
  ${G2O_ROOT}/bin/chordal_comparator -i 100 -guessOdometry -solver gn_fix6_3_cholmod -o ${output_file_chordal} -compareStats ${stats_file_chordal} -otherGraph ${f} chordal/${f}
