...
for f in "${files[@]}"; do
  ...
  ${G2O_ROOT}/bin/noise_adder3d -noiseRotation "0.001;0.001;0.001" -noiseTranslation "0.01;0.01;0.01" -o ${low_noise_file} ${f}
  echo $'\n'
  ...
  ${G2O_ROOT}/bin/noise_adder3d -noiseRotation "0.01;0.01;0.01" -noiseTranslation "0.1;0.1;0.1" -o ${mid_noise_file} ${f}
  echo $'\n'
  ...
  ${G2O_ROOT}/bin/noise_adder3d -noiseRotation "0.1;0.1;0.1" -noiseTranslation "0.5;0.5;0.5" -o ${high_noise_file} ${f}
  echo $'\n'
