...
for f in "${files[@]}"; do
  ...
  ${G2O_ROOT}/bin/chordal_comparator -i 100 -guess -solver gn_fix6_3_cholmod -robustKernel Cauchy -robustKernelWidth 1.0 -o ${output_file_chordal} -compareStats ${stats_file_chordal} -otherGraph ${f} chordal/${f}
