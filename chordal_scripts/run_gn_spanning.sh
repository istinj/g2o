...
for f in "${files[@]}"; do
  ...
  ${G2O_ROOT}/bin/g2o -v -i 100 -guess -solver gn_fix6_3_cholmod -stats ${stats_file_standard} -o ${output_file_standard} ${f}
  ...
  # ${G2O_ROOT}/bin/chordal_comparator -i 100 -guess -solver gn_fix6_3_cholmod -compareStats ${stats_file_compare} -otherGraph ${f} chordal/${f}
