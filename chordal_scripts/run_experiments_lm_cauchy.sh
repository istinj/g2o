...
for d in "${directories[@]}"; do
  ...
  ${pwd}/run_lm_cauchy_no_guess.sh ${d}/ ${statics_directory_dataset}
  # read -p "press any key to continue"

  ${pwd}/run_lm_cauchy_spanning.sh ${d}/ ${statics_directory_dataset}
  # read -p "press any key to continue"

  ${pwd}/run_lm_cauchy_odom.sh ${d}/ ${statics_directory_dataset}
  # read -p "press any key to continue"
