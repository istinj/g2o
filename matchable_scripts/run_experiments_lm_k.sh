...
for d in "${directories[@]}"; do
  ...
  ${pwd}/run_noguess_cauchy.sh ${d}/ ${statics_directory_dataset}
  # read -p "press any key to continue"
  
  ${pwd}/run_spanning_cauchy.sh ${d}/ ${statics_directory_dataset}
  # read -p "press any key to continue"
  
  ${pwd}/run_odometry_cauchy.sh ${d}/ ${statics_directory_dataset}
  # read -p "press any key to continue"
...
echo -e ${REVGREEN}FINISHED EXPERIMENTS LEVEMBERG-MARQUARDT CAUCHY${NC}
cd $pwd
